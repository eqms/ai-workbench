...
/// Standard base64 (padded, `+`/`/` alphabet) over arbitrary bytes.
/// Shared with the iTerm2 file-transfer encoder, which needs to encode
/// binary payloads (PDFs) rather than just UTF-8 strings.
