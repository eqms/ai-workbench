...
pub struct PtyConfig {
    ...
    /// Command for the AI pane in Ollama Pi mode (default: `["ollama", "launch", "pi"]`).
    #[serde(default = "default_ollama_pi_command")]
    pub ollama_pi_command: Vec<String>,
...
fn default_ollama_pi_command() -> Vec<String> {
    vec!["ollama".to_string(), "launch".to_string(), "pi".to_string()]
}
