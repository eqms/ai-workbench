...
.DESCRIPTION
    Downloads the latest ai-workbench release from GitHub and installs it,
...
.PARAMETER InstallDir
    Installation directory (default: $env:LOCALAPPDATA\Programs\ai-workbench).
...
param(
    [switch]$Local,
    [switch]$Check,
    [string]$InstallDir = "$env:LOCALAPPDATA\Programs\ai-workbench",
    [switch]$Help,
    [switch]$Version
)
...
# Configuration
$ScriptVersion = "1.0.0"
$BinaryName = "ai-workbench.exe"
$Repo = "eqms/ai-workbench"
...
function Write-HelpMessage {
    Write-Host ""
    Write-Host "ai-workbench installer (PowerShell)" -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "                   (default: $env:LOCALAPPDATA\Programs\ai-workbench)"
...
function Write-Banner {
    ...
    Write-Host "|        AI Workbench -- Installer v$ScriptVersion              |" -ForegroundColor Blue
    Write-Host "+============================================================+" -ForegroundColor Blue
    Write-Host ""
}
...
function Get-Platform {
    ...
    switch ($arch) {
        "AMD64" {
            $script:AssetName = "ai-workbench-x86_64-pc-windows-msvc.zip"
            $script:PlatformArch = "x64"
        }
        "ARM64" {
            $script:AssetName = "ai-workbench-aarch64-pc-windows-msvc.zip"
...
function Write-Completion {
    ...
    Write-Host "+============================================================+" -ForegroundColor Blue
    Write-Host "|  Run with:  ai-workbench                               |" -ForegroundColor Blue
    Write-Host "+============================================================+" -ForegroundColor Blue
    Write-Host ""
}
