...
```powershell
irm https://raw.githubusercontent.com/eqms/ai-workbench/main/scripts/install.ps1 | iex
```

**Or download manually** from the [Releases](https://github.com/eqms/ai-workbench/releases) page.
...
To update: `brew upgrade ai-workbench`
...
# Or manual download:
# For x64:
curl -LO https://github.com/eqms/ai-workbench/releases/latest/download/ai-workbench-linux-x64
# For ARM64:
curl -LO https://github.com/eqms/ai-workbench/releases/latest/download/ai-workbench-linux-arm64

# Make it executable
chmod +x ai-workbench-linux-*

# Move to a directory in your PATH (optional)
sudo mv ai-workbench-linux-* /usr/local/bin/ai-workbench
...
curl -LO https://github.com/eqms/ai-workbench/releases/latest/download/ai-workbench-macos-arm64
# For Intel:
curl -LO https://github.com/eqms/ai-workbench/releases/latest/download/ai-workbench-macos-x64

# Make it executable
chmod +x ai-workbench-macos-*

# Remove quarantine attribute (first run only)
xattr -d com.apple.quarantine ai-workbench-macos-*

# Move to a directory in your PATH (optional)
sudo mv ai-workbench-macos-* /usr/local/bin/ai-workbench
...
1. Download the appropriate binary from the [Releases](https://github.com/eqms/ai-workbench/releases) page:
   - For x64: `ai-workbench-windows-x64.exe`
   - For ARM64 (Surface Pro X, etc.): `ai-workbench-windows-arm64.exe`
...
```powershell
# Download (x64)
Invoke-WebRequest -Uri "https://github.com/eqms/ai-workbench/releases/latest/download/ai-workbench-windows-x64.exe" -OutFile "ai-workbench.exe"

# Download (ARM64)
# Invoke-WebRequest -Uri "https://github.com/eqms/ai-workbench/releases/latest/download/ai-workbench-windows-arm64.exe" -OutFile "ai-workbench.exe"
...
# The binary will be at target/release/ai-workbench
```
...
On first run, AI Workbench creates a configuration directory:
- Linux/macOS: `~/.config/ai-workbench/`
- Windows: `%APPDATA%\ai-workbench\`

Copy the example configuration:
```bash
cp config.yaml.example ~/.config/ai-workbench/config.yaml
```
...
**Oder manuell herunterladen** von der [Releases](https://github.com/eqms/ai-workbench/releases)-Seite.
...
Zum Aktualisieren: `brew upgrade ai-workbench`
...
1. Laden Sie das passende Binary von der [Releases](https://github.com/eqms/ai-workbench/releases)-Seite herunter:
   - Für x64: `ai-workbench-windows-x64.exe`
   - Für ARM64 (Surface Pro X, etc.): `ai-workbench-windows-arm64.exe`
...
# Das Binary befindet sich unter target/release/ai-workbench
```
...
Beim ersten Start erstellt AI Workbench ein Konfigurationsverzeichnis:
- Linux/macOS: `~/.config/ai-workbench/`
- Windows: `%APPDATA%\ai-workbench\`
